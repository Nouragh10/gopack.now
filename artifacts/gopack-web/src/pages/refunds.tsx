export default function Refunds() {
  return (
    <div style={{
      ...
      <p>To cancel: go to your <strong>Profile</strong> page in the app and tap <strong>Manage Subscription</strong>, or email us at <a href="mailto:support@gopacknow.com" style={{ color: "#E85D3A" }}>support@gopacknow.com</a>.</p>
      ...
      <p>Email <a href="mailto:support@gopacknow.com" style={{ color: "#E85D3A" }}>support@gopacknow.com</a> with your account email and a brief description. We aim to respond within 2 business days. Approved refunds are processed by Paddle and typically appear on your statement within 5–10 business days depending on your bank.</p>
