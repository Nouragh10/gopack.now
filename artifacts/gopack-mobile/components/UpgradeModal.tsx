...
const FEATURES = [
  ...
  { icon: "refresh-cw", label: "20 activity redos per trip" },
...
export function UpgradeModal({ visible, reason, tripId, onClose }: Props) {
      ...
      <Pressable style={styles.overlay} onPress={onClose}>
        <Pressable style={[styles.sheet, { backgroundColor: colors.card }]}>
          ...
          <Pressable
            ...
            disabled={loading}
            style={[styles.cta, { backgroundColor: "#E85D3A", opacity: loading ? 0.7 : 1 }]}
          >
            {loading ? (
              ...
              <>
                ...
                <Text style={styles.ctaText}>Upgrade — $14.99</Text>
              </>
            )}
          </Pressable>
...
const styles = StyleSheet.create({
  ...
  cta: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, borderRadius: 14, paddingVertical: 16, marginBottom: 12 },
